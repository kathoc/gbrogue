...
BUTTON_GLYPHS = {
    _A:   [0x7E, 0xE7, 0xDB, 0xDB, 0xC3, 0xDB, 0xDB, 0x7E],  # A
    _B:   [0x7E, 0xC7, 0xDB, 0xC7, 0xDB, 0xDB, 0xC7, 0x7E],  # B
    _STL: [0x7F, 0xE0, 0xDD, 0xCD, 0xE5, 0xF5, 0xCD, 0x7F],  # START L
    _STR: [0xFE, 0x23, 0x57, 0x57, 0x37, 0x57, 0x57, 0xFE],  # START R
    _SEL: [0x7F, 0xF2, 0xEE, 0xE6, 0xF2, 0xFA, 0xE6, 0x7F],  # SELECT L
    _SER: [0xFE, 0x2F, 0xEF, 0x6F, 0xEF, 0xEF, 0x27, 0xFE],  # SELECT R
}
